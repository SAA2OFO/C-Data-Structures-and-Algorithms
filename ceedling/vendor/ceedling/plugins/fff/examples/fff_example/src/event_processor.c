...
void event_volumeKnobMaxed(void) { display_setVolume(11); }
...
static void displayUpdateComplete(void) { event_lastComplete = true; }
...
bool eventProcessor_isLastEventComplete(void) { return event_lastComplete; }
