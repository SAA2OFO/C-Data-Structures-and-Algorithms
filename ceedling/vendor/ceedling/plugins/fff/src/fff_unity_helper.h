...
#define TEST_ASSERT_CALLED_TIMES(times_, function_)                            \
  TEST_ASSERT_EQUAL_MESSAGE(times_, function_##_fake.call_count,               \
                            "Function " #function_                             \
                            " called the incorrect number of times.")
/*
...
#define TEST_ASSERT_CALLED_IN_ORDER(order_, function_)                         \
  TEST_ASSERT_EQUAL_PTR_MESSAGE((void *)function_, fff.call_history[order_],   \
                                "Function " #function_                         \
                                " not called in order " #order_)
