...
FAKE_VOID_FUNC(voidfunc20, int, int, int, int, int, int, int, int, int, int,
...
TEST_F(FFFTestSuite, default_constants_can_be_overridden) {
  unsigned sizeCallHistory =
      (sizeof fff.call_history) / (sizeof fff.call_history[0]);
