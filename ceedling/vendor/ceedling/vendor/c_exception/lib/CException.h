...
#define CEXCEPTION_VERSION                                                     \
  ((CEXCEPTION_VERSION_MAJOR << 16) | (CEXCEPTION_VERSION_MINOR << 8) |        \
   CEXCEPTION_VERSION_BUILD)
...
// 3. Include a header file before CException.h everywhere which defines any of
// these
